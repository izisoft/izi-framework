 ...
 *
 * To declare an ActiveRecord class you need to extend [[\izi\db\ActiveRecord]] and
 * implement the `tableName` method:
 *
 * ```php
 * <?php
 *
 * class Customer extends \izi\db\ActiveRecord
 * {
...
class ActiveRecord extends BaseActiveRecord
{
    ...
    {
        return Izi::createObject(ActiveQuery::className(), [get_called_class()]);
    }
    ...
    public function insert($runValidation = true, $attributes = null)
    {
        if ($runValidation && !$this->validate($attributes)) {
            Izi::info('Model not inserted due to validation error.', __METHOD__);
            return false;
        }
    ...
    public function update($runValidation = true, $attributeNames = null)
    {
        if ($runValidation && !$this->validate($attributeNames)) {
            Izi::info('Model not updated due to validation error.', __METHOD__);
            return false;
        }
