...
use izi\base\StaticInstanceInterface;
...
interface ActiveRecordInterface extends StaticInstanceInterface
{
     ...
     *  - a izi\db\Expression: The expression will be used directly. (@since 2.0.37)
     *
     ...
     *
     * ```php
     * // izi\web\Controller ensures that $id is scalar
     ...
     * ```
     *
     * @param bool $runValidation whether to perform validation (calling [[\izi\base\Model::validate()|validate()]])
