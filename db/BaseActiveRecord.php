...
use izi\base\Model;
use izi\base\ModelEvent;
use izi\base\NotSupportedException;
use izi\base\UnknownMethodException;
use izi\helpers\ArrayHelper;

/**
 * ActiveRecord is the base class for classes representing relational data in terms of objects.
 *
 * See [[\izi\db\ActiveRecord]] for a concrete implementation.
 *
...
abstract class BaseActiveRecord extends Model implements ActiveRecordInterface
{
     ...
     *    Or add [[\izi\behaviors\OptimisticLockBehavior|OptimisticLockBehavior]] to your model
     ...
     * [[\izi\behaviors\AttributeTypecastBehavior]] to facilitate attribute typecasting.
     * See https://framework.iziweb.net/doc-2.0/guide-db-active-record.html#attributes-typecasting.
     */
    ...
    public function link($name, $model, $extraColumns = [])
    {
        ...
        if ($relation->via !== null) {
            ...
            if (is_array($relation->via)) {
                ...
                $record = Izi::createObject($viaClass);
