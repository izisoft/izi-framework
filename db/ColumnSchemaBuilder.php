...
class ColumnSchemaBuilder extends BaseObject
{
    ...
    /**
     * @var \izi\db\Connection the current database connection. It is used mainly to escape strings
     ...
     * @param \izi\db\Connection $db the current database connection. See [[$db]].
