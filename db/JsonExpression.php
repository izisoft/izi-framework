...
class JsonExpression implements ExpressionInterface, \JsonSerializable
{
     ...
     * The value must be compatible with [\izi\helpers\Json::encode()|Json::encode()]] input requirements.
     */
    protected $value;
    /**
     ...
     * The value must be compatible with [\izi\helpers\Json::encode()|Json::encode()]] requirements.
