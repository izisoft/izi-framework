 ...
 *
 * Migration is designed to be used together with the "izi migrate" command.
 *
 ...
 * logic. The "izi migrate" command manages all available migrations in an application.
 *
