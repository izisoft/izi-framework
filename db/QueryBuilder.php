...
use izi\db\conditions\ConditionInterface;
use izi\db\conditions\HashCondition;
 ...
 * ```php ['LIKE' => izi\db\condition\LikeCondition::class] ``` . This property is write-only.
 ...
 * @since 2.0
 */
class QueryBuilder extends \izi\base\BaseObject
{
    /**
     ...
     * ```php
     * return [
     *     'LIKE' => izi\db\condition\LikeCondition::class,
     * ];
     * ```
     *
     ...
     * ```php
     * [
     *    izi\db\Expression::class => izi\db\ExpressionBuilder::class
     * ]
     * ```
    ...
    {
        return [
            'NOT' => 'izi\db\conditions\NotCondition',
            'AND' => 'izi\db\conditions\AndCondition',
            'OR' => 'izi\db\conditions\OrCondition',
            'BETWEEN' => 'izi\db\conditions\BetweenCondition',
            'NOT BETWEEN' => 'izi\db\conditions\BetweenCondition',
            'IN' => 'izi\db\conditions\InCondition',
            'NOT IN' => 'izi\db\conditions\InCondition',
            'LIKE' => 'izi\db\conditions\LikeCondition',
            'NOT LIKE' => 'izi\db\conditions\LikeCondition',
            'OR LIKE' => 'izi\db\conditions\LikeCondition',
            'OR NOT LIKE' => 'izi\db\conditions\LikeCondition',
            'EXISTS' => 'izi\db\conditions\ExistsCondition',
            'NOT EXISTS' => 'izi\db\conditions\ExistsCondition',
        ];
    }
    ...
    {
        return [
            'izi\db\Query' => 'izi\db\QueryExpressionBuilder',
            'izi\db\PdoValue' => 'izi\db\PdoValueBuilder',
            'izi\db\Expression' => 'izi\db\ExpressionBuilder',
            'izi\db\conditions\ConjunctionCondition' => 'izi\db\conditions\ConjunctionConditionBuilder',
            'izi\db\conditions\NotCondition' => 'izi\db\conditions\NotConditionBuilder',
            'izi\db\conditions\AndCondition' => 'izi\db\conditions\ConjunctionConditionBuilder',
            'izi\db\conditions\OrCondition' => 'izi\db\conditions\ConjunctionConditionBuilder',
            'izi\db\conditions\BetweenCondition' => 'izi\db\conditions\BetweenConditionBuilder',
            'izi\db\conditions\InCondition' => 'izi\db\conditions\InConditionBuilder',
            'izi\db\conditions\LikeCondition' => 'izi\db\conditions\LikeConditionBuilder',
            'izi\db\conditions\ExistsCondition' => 'izi\db\conditions\ExistsConditionBuilder',
            'izi\db\conditions\SimpleCondition' => 'izi\db\conditions\SimpleConditionBuilder',
            'izi\db\conditions\HashCondition' => 'izi\db\conditions\HashConditionBuilder',
            'izi\db\conditions\BetweenColumnsCondition' => 'izi\db\conditions\BetweenColumnsConditionBuilder',
        ];
    }
     ...
     * of [[izi\db\Query|Query]] to perform INSERT INTO ... SELECT SQL statement.
     * Passing of [[izi\db\Query|Query]] is available since version 2.0.11.
    ...
    protected function prepareInsertValues($table, $columns, $params = [])
    {
        ...
        if ($columns instanceof Query) {
            ...
            foreach ($columns as $name => $value) {
                ...
                } elseif ($value instanceof \izi\db\Query) {
     ...
     * @param \izi\db\Schema $schema Schema object to quote column name.
     * @param array $params the parameters to be bound to the generated SQL statement. These parameters will
     * be included in the result with the additional parameters generated during the query building process.
     ...
     *     'visits' => 0,
     * ], [
     *     'visits' => new \izi\db\Expression('visits + 1'),
     * ], $params);
     * ```
     *
     * The method will properly escape the table and column names.
     ...
     * to instance of [[izi\db\condition\ConditionInterface|ConditionInterface]] according to
    ...
    public function createConditionFromArray($condition)
    {
        if (isset($condition[0])) { // operator format: operator, operand 1, operand 2, ...
            ...
            if (isset($this->conditionClasses[$operator])) {
                ...
                $className = 'izi\db\conditions\SimpleCondition';
            }
