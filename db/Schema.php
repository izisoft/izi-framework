...
use izi\caching\Cache;
use izi\caching\CacheInterface;
use izi\caching\TagDependency;
...
abstract class Schema extends BaseObject
{
     ...
     */
    public $exceptionMap = [
        'SQLSTATE[23' => 'izi\db\IntegrityException',
    ];
    /**
     * @var string|array column schema class or class config
     * @since 2.0.11
     */
    public $columnSchemaClass = 'izi\db\ColumnSchema';
    ...
    {
        return Izi::createObject($this->columnSchemaClass);
    }
    ...
    public function refresh()
    {
        ...
        $cache = is_string($this->db->schemaCache) ? Izi::$app->get($this->db->schemaCache, false) : $this->db->schemaCache;
    ...
    public function convertException(\Exception $e, $rawSql)
    {
        ...
        $exceptionClass = '\izi\db\Exception';
    ...
    protected function getTableMetadata($name, $type, $refresh)
    {
        ...
        if ($this->db->enableSchemaCache && !in_array($name, $this->db->schemaCacheExclude, true)) {
            $schemaCache = is_string($this->db->schemaCache) ? Izi::$app->get($this->db->schemaCache, false) : $this->db->schemaCache;
