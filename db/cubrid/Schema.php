...
class Schema extends \izi\db\Schema implements ConstraintFinderInterface
{
     ...
     */
    public $exceptionMap = [
        'Operation would have caused one or more unique constraint violations' => 'izi\db\IntegrityException',
    ];
     ...
     * @return \izi\db\ColumnSchema the column schema object
     */
