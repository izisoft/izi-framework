...
use izi\db\Constraint;
use izi\db\Expression;
 ...
 * @since 2.0
 */
class QueryBuilder extends \izi\db\QueryBuilder
{
    /**
    ...
    protected function defaultExpressionBuilders()
    {
        return array_merge(parent::defaultExpressionBuilders(), [
            'izi\db\conditions\InCondition' => 'izi\db\mssql\conditions\InConditionBuilder',
            'izi\db\conditions\LikeCondition' => 'izi\db\mssql\conditions\LikeConditionBuilder',
        ]);
    }
     ...
     * @param array $orderBy the order by columns. See [[\izi\db\Query::orderBy]] for more details on how to specify this parameter.
     * @param int $limit the limit number. See [[\izi\db\Query::limit]] for more details.
     * @param int $offset the offset number. See [[\izi\db\Query::offset]] for more details.
    ...
    public function alterColumn($table, $column, $type)
    {
        ...
        if ($type instanceof \izi\db\mssql\ColumnSchemaBuilder) {
    ...
    protected function getAllColumnNames($modelClass = null)
    {
        ...
        /* @var $modelClass \izi\db\ActiveRecord */
     ...
     * @throws \izi\base\InvalidConfigException
     * @throws \izi\db\Exception
