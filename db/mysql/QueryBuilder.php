...
class QueryBuilder extends \izi\db\QueryBuilder
{
    ...
    protected function defaultExpressionBuilders()
    {
        return array_merge(parent::defaultExpressionBuilders(), [
            'izi\db\JsonExpression' => 'izi\db\mysql\JsonExpressionBuilder',
        ]);
    }
    ...
    private function supportsFractionalSeconds()
    {
        ...
        $cache = null;
        $schemaCache = (\Izi::$app && is_string($this->db->schemaCache)) ? \Izi::$app->get($this->db->schemaCache, false) : $this->db->schemaCache;
