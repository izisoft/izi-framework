...
use izi\base\InvalidCallException;
use izi\base\NotSupportedException;
use izi\db\CheckConstraint;
use izi\db\ColumnSchema;
use izi\db\Connection;
use izi\db\Constraint;
use izi\db\ConstraintFinderInterface;
use izi\db\ConstraintFinderTrait;
use izi\db\Expression;
use izi\db\ForeignKeyConstraint;
use izi\db\IndexConstraint;
use izi\db\TableSchema;
use izi\helpers\ArrayHelper;
 ...
 * @since 2.0
 */
class Schema extends \izi\db\Schema implements ConstraintFinderInterface
{
     ...
     */
    public $exceptionMap = [
        'ORA-00001: unique constraint' => 'izi\db\IntegrityException',
    ];
...
SQL;
     ...
     * @internal param \izi\db\TableSchema $table->name the table schema
