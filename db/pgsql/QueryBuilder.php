...
class QueryBuilder extends \izi\db\QueryBuilder
{
    ...
    protected function defaultConditionClasses()
    {
        return array_merge(parent::defaultConditionClasses(), [
            'ILIKE' => 'izi\db\conditions\LikeCondition',
            'NOT ILIKE' => 'izi\db\conditions\LikeCondition',
            'OR ILIKE' => 'izi\db\conditions\LikeCondition',
            'OR NOT ILIKE' => 'izi\db\conditions\LikeCondition',
        ]);
    }
    ...
    protected function defaultExpressionBuilders()
    {
        return array_merge(parent::defaultExpressionBuilders(), [
            'izi\db\ArrayExpression' => 'izi\db\pgsql\ArrayExpressionBuilder',
            'izi\db\JsonExpression' => 'izi\db\pgsql\JsonExpressionBuilder',
        ]);
    }
