...
class BaseFileHelper
{
     ...
     */
    public static $mimeMagicFile = '@izi/helpers/mimeTypes.php';
    /**
     * @var string the path (or alias) of a PHP file containing MIME aliases.
     * @since 2.0.14
     */
    public static $mimeAliasesFile = '@izi/helpers/mimeAliases.php';
     ...
     * If not set, the value of [[\izi\base\Application::language]] will be used.
     * @param string $sourceLanguage the language that the original file is in.
     * If not set, the value of [[\izi\base\Application::sourceLanguage]] will be used.
    ...
    {
        if ($language === null) {
            $language = Izi::$app->language;
        }
        if ($sourceLanguage === null) {
            $sourceLanguage = Izi::$app->sourceLanguage;
        }
    ...
    {
        if ($magicFile !== null) {
            $magicFile = Izi::getAlias($magicFile);
        }
    ...
    protected static function loadMimeAliases($aliasesFile)
    {
        ...
        $aliasesFile = Izi::getAlias($aliasesFile);
     ...
     * @throws \izi\base\Exception if the directory could not be created (i.e. php error due to parallel changes)
     */
    public static function createDirectory($path, $mode = 0775, $recursive = true)
    {
        ...
        try {
            ...
            if (!is_dir($path)) {// https://github.com/yiisoft/yii2/issues/9288
                throw new \izi\base\Exception("Failed to create directory \"$path\": " . $e->getMessage(), $e->getCode(), $e);
            }
        }
        try {
            return chmod($path, $mode);
        } catch (\Exception $e) {
            throw new \izi\base\Exception("Failed to change permissions for directory \"$path\": " . $e->getMessage(), $e->getCode(), $e);
        }
    }
