...
{
    /**
     * @var array the configuration array for creating a [[\izi\mail\MessageInterface|message]] object.
    ...
    public function init()
    {
        ...
        $this->mailer = Instance::ensure($this->mailer, 'izi\mail\MailerInterface');
    }
     ...
     * @return \izi\mail\MessageInterface $message
     */
    protected function composeMessage($body)
    {
        $message = $this->mailer->compose();
        Izi::configure($message, $this->message);
