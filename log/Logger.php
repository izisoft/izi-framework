 ...
 *
 * A Logger instance can be accessed via `Izi::getLogger()`. You can call the method [[log()]] to record a single log message.
...
class Logger extends Component
{
     ...
     * @since 2.0.41
     */
    public $dbEventNames = ['izi\db\Command::query', 'izi\db\Command::execute'];
     ...
     * For example, 'izi\db\*' will match categories starting with 'izi\db\',
     * such as 'izi\db\Connection'.
