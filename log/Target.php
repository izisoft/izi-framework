...
abstract class Target extends Component
{
     ...
     * match those categories sharing the same common prefix. For example, 'izi\db\*' will match
     * categories starting with 'izi\db\', such as 'izi\db\Connection'.
     */
    public $categories = [];
    /**
     ...
     *
     * @see \izi\helpers\ArrayHelper::filter()
     */
    public $logVars = [
        '_GET',
        '_POST',
    ...
    public function getMessagePrefix($message)
    {
        ...
        /* @var $user \izi\web\User */
        $user = Izi::$app->has('user', true) ? Izi::$app->get('user') : null;
        ...
        /* @var $session \izi\web\Session */
        $session = Izi::$app->has('session', true) ? Izi::$app->get('session') : null;
